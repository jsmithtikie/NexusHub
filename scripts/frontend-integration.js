 ...
 * This file demonstrates how to integrate Nexushub with a web frontend
 */

// For React/Vue/Angular applications
export class NexushubClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NexushubClient(provider, contractAddress);
